...
def main():
    ...
    trajFiles = [file for file in choreoFiles if file.endswith(".traj") and "M" not in file and "C_" not in file and "D" not in file]
    ...
    for file in trajFiles:
        ...
        with open(choreoDirectory + "\\" + "M" + file, 'w') as f:
